          ...
          <>
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="px-4 py-2 text-left">Reclaim Policy</th>
              ...
              {filteredResources.map(resource => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-2">{resource.spec?.capacity?.storage || '-'}</td>
              ...
              {filteredResources.map(resource => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-2">{resource.spec?.volumeName || '-'}</td>
        ...
        return (
          <>
            <thead>
              <tr className="bg-gray-200">
                <th className="px-4 py-2 text-left">Name</th>
                <th className="px-4 py-2 text-left">Provisioner</th>
                <th className="px-4 py-2 text-left">Reclaim Policy</th>
                <th className="px-4 py-2 text-left">Volume Binding Mode</th>
                <th className="px-4 py-2 text-left">Allow Expansion</th>
                <th className="px-4 py-2 text-left">Age</th>
              </tr>
            </thead>
            <tbody>
